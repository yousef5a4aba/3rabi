...
define('administrator_id',187034302); // Change administrator_id to your Telegram ID
define('bote_id','314519621:AAFC-6iF2z1dGqrczhoyc4FRtSYxcMMWut8'); // Change this to your bot ID, get bot ID from BotFather (https://core.telegram.org/bots)
global $bot;
global $players;
global $allplayers;
global $top;
...
$game=array(
	'state'=>0, // 0 - Pause between Issues, 1 - Asked a question
	'timer'=>0, // timer
	'last'=>time(), // Last action (Seconds countdown)
	'question'=>'',
	'answer'=>'',
	'pod'=>0,
);
...
function feedback($userid,$text){
	...
	if (strlen($text)>3){
		...
		$bot->send($userid,'Your message is recorded. Thank you!'); // "Your message wrote. Thanks!"
	}else{
